...
INSERT INTO public.t_caver (id,login,"password",activated,activation_code,banned,connection_counter,relevance,"name",surname,nickname,mail,mail_is_valid,date_inscription,date_last_connection,alert_for_news,show_links,detail_level,default_zoom,id_language) VALUES
	 (0,'deleted','0',false,'0',false,0,1,'deleted','deleted','deleted','no@mail.no',true,'2020-12-21 22:23:20.000',NULL,false,false,30,NULL,'fra'),
	 (1,'user1','xxxxxx',true,'0',false,716,35,'user','name','My Name','no@mail.no',true,'2008-07-28 13:56:41.000','2019-02-06 00:30:06.000',true,false,15,8,'fra'),
	 (2,'user2','xxxxxx',true,'0',false,53,2,'user','name','My Name','no@mail.no',true,'2008-07-28 14:41:41.000','2013-03-26 11:50:09.000',true,true,30,13,'fra'),
	 (3,'user3','xxxxxx',true,'0',false,5,1,'user','name','My Name','no@mail.no',true,'2008-07-28 14:47:13.000','2011-03-02 13:43:59.000',false,false,30,8,'fra'),
	 (4,'user4','xxxxxx',true,'0',false,55,30,'user','name','My Name','no@mail.no',true,'2008-07-28 15:02:08.000','2017-09-16 18:10:06.000',false,false,100,7,'fra'),
	 (5,'user5','xxxxxx',true,'0',false,56,1457,'user','name','My Name','no@mail.no',true,'2008-07-28 15:55:34.000','2011-05-24 14:32:24.000',true,true,10,15,'fra'),
	 (6,'user6','xxxxxx',true,'0',false,404,406,'user',NULL,'My Name','no@mail.no',true,'2008-07-28 16:18:16.000','2019-12-14 12:19:01.000',true,false,30,7,'fra');
