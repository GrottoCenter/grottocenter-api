...
describe('Caver features', () => {
  ...
  it('should return page 1 authors with adminToken', (done) => {
    supertest(sails.hooks.http.app)
      .get('/api/v1/cavers/authors/1')
  ...
  it('should return page 2 authors with adminToken', (done) => {
    supertest(sails.hooks.http.app)
      .get('/api/v1/cavers/authors/2')
      .set('Authorization', adminToken)
      .set('Content-type', 'application/json')
      .set('Accept', 'application/json')
      .expect(200)
      .end((err, res) => {
        ...
        res.body.data.should.be.an.Array().and.have.lengthOf(4);
  ...
  it('should return authors with moderatorToken', (done) => {
    supertest(sails.hooks.http.app)
      .get('/api/v1/cavers/authors/1')
