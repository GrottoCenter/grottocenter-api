...
describe('Caver features', () => {
  ...
  it('should return page 1 contributors with adminToken', (done) => {
  ...
  it('should return page 2 contributors with adminToken', (done) => {
    supertest(sails.hooks.http.app)
      .get('/api/v1/cavers/contributors/2')
      .set('Authorization', adminToken)
      .set('Content-type', 'application/json')
      .set('Accept', 'application/json')
      .expect(200)
  ...
  it('should return page 1 contributors with moderatorToken', (done) => {
    supertest(sails.hooks.http.app)
      .get('/api/v1/cavers/contributors/1')
  ...
  it('should return 404 error', (done) => {
    supertest(sails.hooks.http.app)
      .get('/api/v1/cavers/contributors/100')
      .set('Authorization', adminToken)
      .set('Content-type', 'application/json')
      .set('Accept', 'application/json')
      .expect(404)
