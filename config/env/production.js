...
module.exports = {
   ...
   ************************************************************************** */
  /**
   * Set in production using env variables :
   * sails_datastores__default__user: xxxx
   * sails_datastores__default__password: xxxx
   * sails_datastores__default__database: xxxx
   * sails_datastores__default__url: xxxx
   */
  // },
  models: {
    /** *************************************************************************
  ...
  sockets: {
     ...
     *                                                                          *
     ************************************************************************** */
    onlyAllowOrigins: ['https://grottocenter.org', 'http://grottocenter.org'],
   ...
   ************************************************************************** */
  custom: {
    baseUrl: 'https://grottocenter.org',
  },
};
