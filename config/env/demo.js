/**
 * Local docker environment settings
 * (sails.config.*)
 *
...
module.exports = {
  ...
  /**************************************************************************
  *                                                                         *
  * Tell Sails what database(s) it should use in demo.                      *
  *                                                                         *
  ...
  datastores: {
    ...
    ***************************************************************************/
    default: {
      ...
      url: 'mysql://sailsuser:grottocepassword@'
        + process.env.MYSQLGROTTO_PORT_3306_TCP_ADDR
        + ':'
        + process.env.MYSQLGROTTO_PORT_3306_TCP_PORT
        + '/grottoce',
