      ...
      <div className="container">
        <div className="row">
          <div className="six columns">
            <span className="icon icon-gc-entries" style={{'color':'#885B39','font-size': '4em'}}></span><br/>
            <span style={{'color':'#885B39','font-size': '3em'}}>39175 </span>
          ...
          <div className="six columns">
            <span className="icon icon-gc-club" style={{'color':'#885B39','font-size': '4em'}}></span><br/>
            <span style={{'color':'#885B39','font-size': '3em'}}>16 </span>
        ...
        <div className="row">
          <div className="six columns">
            <span className="icon icon-gc-speleo" style={{'color':'#885B39','font-size': '4em'}}></span><br/>
            <span style={{'color':'#885B39','font-size': '3em'}}>2724 </span>
            <I18n>cavers take part, day after day, in improving and expanding the database</I18n>
          </div>
          <div className="six columns">
            <span className="icon icon-gc-expe" style={{'color':'#885B39','font-size': '4em'}}></span><br/>
            <span style={{'color':'#885B39','font-size': '3em'}}>654 </span>
