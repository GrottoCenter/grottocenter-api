                  ...
                  <div style={{ display: 'inline-flex', justifyContent: 'space-between' }}>
                    <TextField
                      onChange={(event) =>
                        this.handleRangeChange(
                          'aestheticism-range',
                          [parseInt(event.target.value, 10) || 0, aestheticismRange.max],
                          aestheticismMinValue,
                          aestheticismMaxValue,
                        )
                      }
                    ...
                    <TextField
                      onChange={(event) =>
                        this.handleRangeChange(
                          'aestheticism-range',
                          [aestheticismRange.min, parseInt(event.target.value, 10) || 0],
                          aestheticismMinValue,
                          aestheticismMaxValue,
                        )
                      }
                  ...
                  <div style={{ display: 'inline-flex', justifyContent: 'space-between' }}>
                    <TextField
                      onChange={(event) =>
                        this.handleRangeChange(
                          'caving-range',
                          [parseInt(event.target.value, 10) || 0, cavingRange.max],
                          cavingMinValue,
                          cavingMaxValue,
                        )
                      }
                    ...
                    <TextField
                      onChange={(event) =>
                        this.handleRangeChange(
                          'caving-range',
                          [cavingRange.min, parseInt(event.target.value, 10) || 0],
                          cavingMinValue,
                          cavingMaxValue,
                        )
                      }
                  ...
                  <div style={{ display: 'inline-flex', justifyContent: 'space-between' }}>
                    <TextField
                      onChange={(event) =>
                        this.handleRangeChange(
                          'approach-range',
                          [parseInt(event.target.value, 10) || 0, approachRange.max],
                          approachMinValue,
                          approachMaxValue,
                        )
                      }
                    ...
                    <TextField
                      onChange={(event) =>
                        this.handleRangeChange(
                          'approach-range',
                          [approachRange.min, parseInt(event.target.value, 10) || 0],
                          approachMinValue,
                          approachMaxValue,
                        )
                      }
              ...
              <div className={classes.formPartContainer}>
                ...
                <FormControl className={classes.formElement}>
                  ...
                  <NativeSelect
                    ...
                    input={
                      <Input name="cave-is-diving" id="cave-is-diving-native-label-placeholder" />
                    }
                    classes={{
                  ...
                  <div style={{ display: 'inline-flex', justifyContent: 'space-between' }}>
                    <TextField
                      onChange={(event) =>
                        this.handleRangeChange(
                          'cave depth-range',
                          [parseInt(event.target.value, 10) || 0, caveDepthRange.max],
                          caveDepthMinValue,
                          caveDepthMaxValue,
                        )
                      }
                    ...
                    <TextField
                      onChange={(event) =>
                        this.handleRangeChange(
                          'cave depth-range',
                          [caveDepthRange.min, parseInt(event.target.value, 10) || 0],
                          caveDepthMinValue,
                          caveDepthMaxValue,
                        )
                      }
                  ...
                  <div style={{ display: 'inline-flex', justifyContent: 'space-between' }}>
                    <TextField
                      onChange={(event) =>
                        this.handleRangeChange(
                          'cave length-range',
                          [parseInt(event.target.value, 10) || 0, caveLengthRange.max],
                          caveLengthMinValue,
                          caveLengthMaxValue,
                        )
                      }
                    ...
                    <TextField
                      onChange={(event) =>
                        this.handleRangeChange(
                          'cave length-range',
                          [caveLengthRange.min, parseInt(event.target.value, 10) || 0],
                          caveLengthMinValue,
                          caveLengthMaxValue,
                        )
                      }
