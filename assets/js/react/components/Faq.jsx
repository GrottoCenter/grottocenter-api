...
class Faq extends Component {
  ...
  render() {
    let contributeLink = (contributeLinks[this.state.locale] !== undefined) ? contributeLinks[this.state.locale] : contributeLinks['*'];

    return (
      <div className='collapsible_faq' style={{color: this.props.muiTheme.palette.textIconColor}}>
        <Card className="faqCard" style={{backgroundColor: this.props.muiTheme.palette.secondary1Color}}>
          <CardTitle className='faqCardTitle' actAsExpander={true} showExpandableButton={true} style={{color: this.props.muiTheme.palette.textIconColor}}>
        ...
        <Card className="faqCard" style={{backgroundColor: this.props.muiTheme.palette.secondary1Color}}>
          ...
          <CardText expandable={true} style={{backgroundColor: this.props.muiTheme.palette.textIconColor}}>
            <ul className="listing">
              <li>
                <CheckIcon color={this.props.muiTheme.palette.accent1Color}/>
                <I18n>You can show your support by  joining  Grottocenter <GCLink href={contributeLink} alt='Link to become a member'>as active member</GCLink></I18n>
              </li>
              <li>
                <CheckIcon color={this.props.muiTheme.palette.accent1Color}/>
                  <I18n>Here is another way: In order to share with the greatest number, we are  always  <GCLink href={contributeLink} alt='Link to become a translator'>looking for translators</GCLink></I18n>
              </li>
              <li>
                <CheckIcon color={this.props.muiTheme.palette.accent1Color}/>
                  <I18n>If you have programming skills how about  <GCLink href={contributeLink} alt='Link to become a developer'>joining our team of developpers</GCLink></I18n>
              </li>
              <li>
                <CheckIcon color={this.props.muiTheme.palette.accent1Color}/>
                  <I18n>As a group, a club or  federation,  <GCLink href={contributeLink} alt='Link to become a partner'>you can be  one of our partners</GCLink> : The project will move on thanks to  organizations such as yours</I18n>
              </li>
            </ul>
          </CardText>
        </Card>
