...
const CommentContainer = withStyles(theme => ({
  root: {
    margin: 'auto',
    color: '#333',
    margin: 'auto',
...
const Hiker = withStyles(theme => ({
  root: {
    color: '#795548',
  },
}), { withTheme: true })(DirectionsWalk);

const Mountain = withStyles(theme => ({
  root: {
    color: '#795548',
  },
}), { withTheme: true })(FilterHdr);
