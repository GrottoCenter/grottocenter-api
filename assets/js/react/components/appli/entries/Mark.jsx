...
const NameMark = withStyles(theme => ({
  root: {
    margin: 'auto',
    fontWeight: '400',
    textAlign: 'center',
...
const MarkContainer = withStyles(theme => ({
  root: {
    minWidth: '120px',
    maxWidth: '30%',
...
const StarContainer = withStyles(theme => ({
  root: {
    marginTop: '5px',
    fontWeight: '400',
    textAlign: 'center',
...
const YellowStar = withStyles(theme => ({
  root: {
    color: '#f39c12',
  },
}), { withTheme: true })(Star);

const YellowStarHalf = withStyles(theme => ({
  root: {
    color: '#f39c12',
  },
}), { withTheme: true })(StarHalf);

const GreyStar = withStyles(theme => ({
  root: {
    color: '#bdc3c7',
  },
}), { withTheme: true })(Star);
