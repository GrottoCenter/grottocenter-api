    ...
    if (isMobile) {
      ...
      return (
        <div>
          ...
          <EditButton>
            <Create />
            <StyledTypography component="span"><Translate id="Edit" /></StyledTypography>
          </EditButton>
        </div>
      );
      ...
      return (
        ...
        <div>
          ...
          <ActionButton href="">
            <Share />
            <StyledTypography component="span"><Translate id="Share!" /></StyledTypography>
          </ActionButton>


          <ActionButton href="">
            <Print />
            <StyledTypography component="span"><Translate id="Print" /></StyledTypography>
          </ActionButton>
