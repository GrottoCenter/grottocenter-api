  ...
  render: function() {
    ...
    return (
		React.createElement("tr", null,
			React.createElement("td", null, this.props.cave.id),
			React.createElement("td", null, this.props.cave.author.nickname),
			React.createElement("td", null, this.props.cave.name),
			React.createElement("td", null, entryElement),
			React.createElement("td", null, this.props.cave.depth),
			React.createElement("td", null, this.props.cave.length),
			React.createElement("td", null, this.props.cave.isDiving),
			React.createElement("td", null, this.props.cave.temperature),
			React.createElement("td", null, this.props.cave.dateInscription),
			React.createElement(CActionButtons, {id: this.props.cave.id})
		)
    );
  }
});
...
var CProductTable = React.createClass({
  render: function() {
    ...
    this.props.caves.forEach(function(cave) {
      rows.push(React.createElement(CProductRow, {cave: cave, key: cave.id}));
    });
    return (
			...
			React.createElement("table", {className: "table table-striped"},
				React.createElement("thead", null,
					React.createElement("tr", null,
						...
						React.createElement("th", null, "Cave name"),
						React.createElement("th", null, "Entry(ies)"),
						React.createElement("th", null, "Depth"),
						React.createElement("th", null, "Length"),
						React.createElement("th", null, "Diving ?"),
  ...
  render: function() {
    return (
		React.createElement("form", null, 
			React.createElement("label", {htmlFor: "caveSearch"}, "Filter cave name: "),
			React.createElement("input", {id: "caveSearch", 
										  type: "text", 
										  placeholder: "Search...", 
  ...
  render: function() {
	return (
		React.createElement("div", null, 
			React.createElement(CSearchBar, {filterName: this.state.filterName, onUserInput: this.handleUserInput}),
