...
var PartnerCarouselLinks = React.createClass({
  render: function() {
	...
	for (var i = 0; i < pageCount; i++) {
		if (first === true) {
			pages.push(<li className="active" data-target="#myCarousel" data-slide-to={i} ></li>);
			first = false;
		} else {
			pages.push(<li data-target="#myCarousel" data-slide-to={i} ></li>);
		}
	}
...
var PartnerCarouselScreen = React.createClass({
  render: function() {
	...
	this.props.items.forEach(function(partner) {
		var url = "/images/partners/aravisexplo.png";// + partner.pictureFileName;
		rows.push(<div><img src={url} alt={partner.name} key={partner.id} /></div>);
	});
        ...
        return (
            <div id="myCarousel" className="carousel slide" data-ride="carousel">
				...
				<a className="left carousel-control" href="#myCarousel" role="button" data-slide="prev">
					<span className="slideleft" aria-hidden="true">	&lt; </span>
					<span className="sr-only">Previous</span>
				</a>
				
				<a className="right carousel-control" href="#myCarousel" role="button" data-slide="next">
					<span className="slideright" aria-hidden="true"> &gt; </span>
