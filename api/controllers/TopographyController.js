...
module.exports = {
  create: (req, res) =>
    res.badRequest('TopographyController.create not yet implemented!'),

  update: (req, res) =>
    res.badRequest('TopographyController.update not yet implemented!'),

  delete: (req, res) =>
    res.badRequest('TopographyController.delete not yet implemented!'),
