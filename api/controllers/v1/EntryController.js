...
module.exports = {
  find: (req, res) =>
    entryController.find(req, res, MappingV1Service.convertToEntryModel),

  findAll: (req, res) =>
    entryController.findAll(req, res, MappingV1Service.convertToEntryList),
  ...
  getPublicEntriesNumber: (req, res) =>
    entryController.getPublicEntriesNumber(
      req,
      res,
