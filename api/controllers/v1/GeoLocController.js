...
module.exports = {
  ...
  findEntrancesCoordinates: (req, res) => GeolocController.findEntrancesCoordinates(req, res),

  findEntrances: (req, res) => GeolocController.findEntrances(req, res),

  findGrottos: (req, res) => GeolocController.findGrottos(req, res),

  findNetworksCoordinates: (req, res) => GeolocController.findNetworksCoordinates(req, res),
