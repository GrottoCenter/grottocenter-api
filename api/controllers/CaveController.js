...
module.exports = {
  create: (req, res) => res.badRequest('CaveController.create not yet implemented!'),

  update: (req, res) => res.badRequest('CaveController.update not yet implemented!'),

  delete: (req, res) => res.badRequest('CaveController.delete not yet implemented!'),

  find: (req, res) => {
    TCave.findOneById(req.params.id)
      .populate('author')
      .populate('entries')
