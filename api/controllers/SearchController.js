...
module.exports = {
   ...
   * - resourceType:  string, entity type to search for (@see ElasticsearchService.INDEX_NAMES) (FACULTATIVE).
   * - resourceTypes:  Array of string, entity types to search for (@see ElasticsearchService.INDEX_NAMES) (FACULTATIVE).
   ...
   * - resourceType: string, entity type to search for (@see ElasticsearchService.INDEX_NAMES) (MANDATORY)
  ...
  advancedSearch: (req, res) => {
    ...
    if (!ElasticsearchService.INDEX_NAMES.includes(paramsURL.resourceType)) {
      return res.badRequest();
    }
